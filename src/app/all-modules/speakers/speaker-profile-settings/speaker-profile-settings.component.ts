...
@Component({
  selector: 'app-speaker-profile-settings',
  templateUrl: './speaker-profile-settings.component.html',
  styleUrls: ['./speaker-profile-settings.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class SpeakerProfileSettingsComponent implements OnInit {
  ...
  tagitemsSpecialization = [
    'Digital Events', 'Tech Events'
  ];
