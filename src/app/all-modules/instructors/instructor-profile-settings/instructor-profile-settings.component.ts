...
declare var $: any;
@Component({
  selector: 'app-instructor-profile-settings',
  templateUrl: './instructor-profile-settings.component.html',
  styleUrls: ['./instructor-profile-settings.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class InstructorProfileSettingsComponent implements OnInit {
